@extends('index')
@section('title', 'Jabatan Kabupaten')
@section('content')
    <div class="page-header">
        <div>
            <h1 class="page-title">Jabatan Desa</h1>
            <ol class="breadcrumb">
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Table Data Jabatan Desa</h3>
                </div>
                <div class="card-body">
                    @if (session('success'))
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            ...
                                            <form style="display: inline;"
                                                action="{{ url('/admin/des/master/jabatan/' . $data->id) }}" method="post">
                                                @method('DELETE')
                                                @csrf
    ...
    <div class="modal fade" id="modaldemo8">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form class="needs-validation was-validated" method="POST" action="{{ url('/admin/des/master/jabatan') }}">
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <form class="needs-validation was-validated" method="POST"
                        action="{{ url('/admin/des/master/jabatan/' . $edit->id) }}">
                        @method('PUT')
                        @csrf
                        <div class="modal-body">
                            <div class="col-lg-12">
