...
@section('content')
    <div class="page-header">
        <div>
            <h1 class="page-title">Jabatan Table</h1>
            <ol class="breadcrumb">
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            ...
                                            <form style="display: inline;"
                                                action="{{ url('/admin/kab/master/jabatan/' . $data->id) }}" method="post">
                                                @method('DELETE')
                                                @csrf
    ...
    <div class="modal fade" id="modaldemo8">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form class="needs-validation was-validated" method="POST" action="{{ url('/admin/kab/master/jabatan') }}">
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <form class="needs-validation was-validated" method="POST"
                        action="{{ url('/admin/kab/master/jabatan/' . $edit->id) }}">
                        @method('PUT')
                        @csrf
                        <div class="modal-body">
                            <div class="col-lg-12">
