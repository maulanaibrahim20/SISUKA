...
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        <div
            ...
            <h5 class="card-title mb-sm-0 me-2"><span class="text-muted fw-light">Create Katalog Makeup /</span>
                {{ $page_active }}
            </h5>
            <div class="action-btns">
                <a href="{{ url('/owner/katalog/create') }}" class="btn btn-primary fa fa-plus"> Add New
                    Owner</a>
            </div>
        </div>
