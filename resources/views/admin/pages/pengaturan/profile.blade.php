                        ...
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-xl-6">
                                <div class="wideget-user-desc d-sm-flex">
                                    ...
                                    <div class="user-wrap">
                                        ...
                                        <h6 class="text-muted mb-3">{{ auth()->user()->roles->first()->name }}
                                            @if (auth()->user()->hasRole('ADMIN_KAB'))
                                                {{ $wilayahName }}
                                            @elseif (auth()->user()->hasRole('ADMIN_KEC'))
                                                {{ $wilayahName }}
                                            @elseif (auth()->user()->hasRole('ADMIN_DES'))
                                                {{ $wilayahName }}
                                            @endif
                                        </h6>
                            ...
                            <div class="col-lg-12 col-md-12 col-xl-6">
                                <div class="text-xl-right mt-4 mt-xl-0">
                                    ...
                                    <a href="{{ url('/admin/kab/profile/edit_profile') }}" class="btn btn-primary">Edit
                                        Profile</a>
                                </div>
                                <div class="mt-5">
            ...
            <div class="tab-content">
                    ...
                    <ul class="widget-users row  mb-5">
                        ...
                        <li class="col-lg-4 col-md-6 col-sm-12 col-12">
                            <div class="card border p-0">
                                <a href="profile.html">
                                    <div class="card-body text-center">
                                        <span class="avatar avatar-xxl brround cover-image"
                                            data-bs-image-src="{{ url('/assets') }}/images/users/9.jpg"></span>
                        ...
                        <li class="col-lg-4 col-md-6 col-sm-12 col-12">
                            <div class="card border p-0">
                                <a href="profile.html">
                                    <div class="card-body text-center">
                                        <span class="avatar avatar-xxl brround cover-image"
                                            data-bs-image-src="{{ url('/assets') }}/images/users/20.jpg"></span>
                        ...
                        <li class="col-lg-4 col-md-6 col-sm-12 col-12">
                            <div class="card border p-0 mb-0">
                                <div class="card-body text-center">
                                    <span class="avatar avatar-xxl brround cover-image"
                                        data-bs-image-src="{{ url('/assets') }}/images/users/6.jpg"></span>
                                    <a href="profile.html">
                ...
                <div class="tab-pane" id="tab-71">
                    <div class="row  mb-5 img-gallery" id="lightgallery">
                        <div class="col-lg-3 col-md-6" data-responsive="{{ url('/assets') }}/images/media/8.jpg"
                            data-src="{{ url('/assets') }}/images/media/8.jpg">
                            <a href="javascript:void(0);"><img class="img-fluid mb-2 br-7"
                                    src="{{ url('/assets') }}/images/media/8.jpg " alt="banner image"></a>
                        </div>
                        <div class="col-lg-3 col-md-6" data-responsive="{{ url('/assets') }}/images/media/10.jpg"
                            data-src="{{ url('/assets') }}/images/media/10.jpg">
                            <a href="javascript:void(0);"><img class="img-fluid mb-2 br-7"
                                    src="{{ url('/assets') }}/images/media/10.jpg" alt="banner image "></a>
                        </div>
                        <div class="col-lg-3 col-md-6" data-responsive="{{ url('/assets') }}/images/media/11.jpg"
                            data-src="{{ url('/assets') }}/images/media/11.jpg">
                            <a href="javascript:void(0);"><img class="img-fluid  mb-2 br-7"
                                    src="{{ url('/assets') }}/images/media/11.jpg" alt="banner image "></a>
                        </div>
                        <div class="col-lg-3 col-md-6" data-responsive="{{ url('/assets') }}/images/media/12.jpg"
                            data-src="{{ url('/assets') }}/images/media/12.jpg">
                            <a href="javascript:void(0);"><img class="img-fluid  mb-2 br-7"
                                    src="{{ url('/assets') }}/images/media/12.jpg" alt="banner image "></a>
                        </div>
                        <div class="col-lg-3 col-md-6" data-responsive="{{ url('/assets') }}/images/media/13.jpg"
                            data-src="{{ url('/assets') }}/images/media/13.jpg">
                            <a href="javascript:void(0);"><img class="img-fluid  mb-2 br-7"
                                    src="{{ url('/assets') }}/images/media/13.jpg " alt="banner image"></a>
                        </div>
                        <div class="col-lg-3 col-md-6" data-responsive="{{ url('/assets') }}/images/media/14.jpg"
                            data-src="{{ url('/assets') }}/images/media/14.jpg">
                            <a href="javascript:void(0);"><img class="img-fluid  mb-2 br-7"
                                    src="{{ url('/assets') }}/images/media/14.jpg " alt="banner image"></a>
                        </div>
                        <div class="col-lg-3 col-md-6" data-responsive="{{ url('/assets') }}/images/media/15.jpg"
                            data-src="{{ url('/assets') }}/images/media/15.jpg">
                            <a href="javascript:void(0);"><img class="img-fluid mb-2 br-7"
                                    src="{{ url('/assets') }}/images/media/15.jpg " alt="banner image"></a>
                        </div>
                        <div class="col-lg-3 col-md-6" data-responsive="{{ url('/assets') }}/images/media/16.jpg"
                            data-src="{{ url('/assets') }}/images/media/16.jpg">
                            <a href="javascript:void(0);"><img class="img-fluid mb-2 br-7"
                                    src="{{ url('/assets') }}/images/media/16.jpg " alt="banner image"></a>
                        </div>
                        <div class="col-lg-3 col-md-6" data-responsive="{{ url('/assets') }}/images/media/17.jpg"
                            data-src="{{ url('/assets') }}/images/media/17.jpg">
                            <a href="javascript:void(0);"><img class="img-fluid mb-2 br-7"
                                    src="{{ url('/assets') }}/images/media/17.jpg " alt="banner image"></a>
                        </div>
                        <div class="col-lg-3 col-md-6" data-responsive="{{ url('/assets') }}/images/media/18.jpg"
                            data-src="{{ url('/assets') }}/images/media/18.jpg">
                            <a href="javascript:void(0);"><img class="img-fluid mb-2 br-7"
                                    src="{{ url('/assets') }}/images/media/18.jpg " alt="banner image"></a>
                        </div>
                        <div class="col-lg-3 col-md-6" data-responsive="{{ url('/assets') }}/images/media/19.jpg"
                            data-src="{{ url('/assets') }}/images/media/19.jpg">
                            <a href="javascript:void(0);"><img class="img-fluid mb-2 br-7"
                                    src="{{ url('/assets') }}/images/media/19.jpg " alt="banner image"></a>
                        </div>
                        <div class="col-lg-3 col-md-6" data-responsive="{{ url('/assets') }}/images/media/20.jpg"
                            data-src="{{ url('/assets') }}/images/media/20.jpg">
                            <a href="javascript:void(0);"><img class="img-fluid br-7"
                                    src="{{ url('/assets') }}/images/media/20.jpg " alt="banner image"></a>
                        </div>
                    </div>
                </div>
                <div class="tab-pane" id="tab-71">
                    <div class="row  mb-5">
                            ...
                            <div class="card border p-0 over-flow-hidden">
                                <div class="media card-body media-xs overflow-visible ">
                                    <img class="avatar brround avatar-md me-3"
                                        src="{{ url('/assets') }}/images/users/18.jpg" alt="avatar-img">
                        ...
                        <div class=" col-lg-6 col-md-12">
                            <div class="card border p-0 over-flow-hidden mb-lg-0">
                                <div class="media card-body media-xs overflow-visible ">
                                    <img class="avatar brround avatar-md me-3"
                                        src="{{ url('/assets') }}/images/users/2.jpg" alt="avatar-img">
                                    <div class="media-body valign-middle mt-0">
                    ...
                    <div class="row">
                        ...
                        <div class=" col-lg-6 col-md-12">
                            <div class="card border p-0 over-flow-hidden">
                                <div class="media card-body media-xs overflow-visible ">
                                    <img class="avatar brround avatar-md me-3"
                                        src="{{ url('/assets') }}/images/users/3.jpg" alt="avatar-img">
                                    <div class="media-body valign-middle mt-0">
