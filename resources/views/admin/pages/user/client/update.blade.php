        ...
        <div class="col-md">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    @endif
                    <form action="{{ url('/admin/create/client/' . $user->id_customer) }}" method="POST"
                        ...
                        <div class="mb-3 form-password-toggle">
                            ...
                            <div class="input-group input-group-merge">
                                <input type="password" name="password" id="bs-validation-password" class="form-control"
                                    placeholder="&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;"
                                    required value="{{ $user->user->password }}" />
                        ...
                        <div class="mb-3">
                            ...
                            <div class="form-check mb-2">
                                <input type="radio" id="bs-validation-radio-male" value="male" name="jk"
                                    class="form-check-input" {{ $user->jk == 'male' ? 'checked' : '' }} required />
                                <label class="form-check-label" for="bs-validation-radio-male">Laki Laki</label>
                            </div>
                            <div class="form-check">
                                <input type="radio" id="bs-validation-radio-female" value="female" name="jk"
                                    class="form-check-input" {{ $user->jk == 'female' ? 'checked' : '' }} required />
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="pekerjaan" id="bs-validation-email" class="form-control"
                                placeholder="john.doe" value="{{ $user->pekerjaan }}" aria-label="john.doe" required />
                            <div class="valid-feedback">Looks good!</div>
