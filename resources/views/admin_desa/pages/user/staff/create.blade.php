...
@section('content')
    <div class="page-header">
        <div>
            <h1 class="page-title">Create Staff Desa</h1>
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="javascript:void(0);">Home</a></li>
                <li class="breadcrumb-item active" aria-current="page">Create Staff Desa</li>
            </ol>
        </div>
    </div>
    <div class="col-md">
        <div class="card">
            <div class="card-body">
                ...
                @endif
                <form action="{{ url('/admin/des/create/staff') }}" method="POST" class="needs-validation" novalidate>
                    @csrf
